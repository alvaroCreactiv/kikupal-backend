        ...
        <div class="box">
          ...
          <div class="box-body">            
            <div class="container-fluid" style="margin-bottom: 15px;">
              <div class="col-sm-6 col-xs-12" style="border-right: 1px solid #ECF0F5">
                <header class="text-center">Search by Amount:</header>
                <div class="col-md-6">
                  <input type="text" name="mini" id="mini" class="form-control" />
                </div>
                <div class="col-md-6">
                  <input type="text" name="maxi" id="maxi" class="form-control" />
                </div>      
              </div>
              <div class="col-sm-6 col-xs-12">
                <header class="text-center">Search by Date:</header>
                <div class="col-md-6">
                  <input type="text" name="minDate" id="minDate" class="form-control" />
                </div>
                <div class="col-md-6">
