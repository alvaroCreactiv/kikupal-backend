...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">New Services Provider</li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">Service Provider Information</h3>
      ...
      <form method="POST" onsubmit="return servicesProvider()">  
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
              <div class="form-group text-center">
                ...
                <select class="selectpicker  form-control show-tick" data-live-search="true" data-width="100%" data-style="btn-primary" id="type" name="type"   > 
                  <?php 
                  $respuesta= ControladorAdministradores::ctrMostrarTypeService();
                  foreach ($respuesta as $key => $value) 
                  {
                    echo '<option value="'.$value["id_service"].'">'.$value["name"].'</option>';
                  }
                  ?>       
          ...
          <div class="row">
            <div class="col-sm-6 col-xs-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="serwebsite" name="serwebsite">
              </div>
            </div>
            <div class="col-sm-6 col-xs-12"> 
              <div class="form-group">
                <label for="">Contact Name:</label>
                <input type="text" class="form-control" id="sercontact" name="sercontact">
              </div>
            </div>
          </div>
          ...
          <div class="checkBox">
            ...
            <input id="regPoliticas" type="checkbox" class="form-control" />
        ...
        <!-- /.box-body -->
        <?php 
        $regProvider= new ControladorAdministradores();
        $regProvider -> ctrRegistroProvider(); 
        ?>
...
<div class="modal fade modalTerminos" id="modalTerminos" role="dialog">
  ...
  <div class="modal-content modal-dialog terminos">
    ...
    <div class="modal-body modalTitulo">
      ...
      <div class="contenido">
        ...
        <p>KIKUPAL’S SERVICES MAY BE SUBJECT TO LIMITATIONS, DELAYS, AND OTHER PROBLEMS INHERENT IN THE USE OF THE INTERNET AND ELECTRONIC COMMUNICATIONS. KIKUPAL IS NOT RESPONSIBLE FOR ANY DELAYS, DELIVERY FAILURES, OR OTHER DAMAGE RESULTING FROM SUCH PROBLEMS.</p>
        ...
        <p>KIKUPAL currently offers one way to pay for your order, PayPal. These payment options use advanced SSL encryption to keep your transaction secure and do not cost you anything to use (KIKUPAL is charged as the seller, you are not charged as the buyer) so you will not pay any extra for your order. You do not need to hold an account with these Merchants to use these methods of payments. Please refer to PayPal for full terms and conditions of use.</p>
        ...
        <p>KIKUPAL alone (and its licensors, where applicable) shall own all of the right, title and interest (including all related intellectual property rights), in and to the past, present, and future versions of the Services and all content therein.</p>

        <p>This content shall include, but is not limited to all layout, text, illustrations, instructions, files, images, designs, software, scripts, graphics, photos, sounds, music, videos, information, materials, technology, interactive features, the “look and feel” of the Services, the compilation and arrangement of the  Services, KIKUPAL trademarks, all copyrightable material (including source code and object code) and derivative works or enhancements of any of the above. Any partial or total reproduction of this content, by any means and on any support, is subject to prior and express authorization by KIKUPAL. </p>
